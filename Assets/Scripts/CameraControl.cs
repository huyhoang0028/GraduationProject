...
public class CameraControl : MonoBehaviour {
	...
	public static CameraControl camfollow;
//	[HideInInspector]
...
//	[HideInInspector]
    ...
    void Start()
    {
		maxXAndY = GameManager.Instace.level [Menu.selectedLevel].camPos_maxXY;
		minXAndY = GameManager.Instace.level [Menu.selectedLevel].camPos_minXY;
    }
